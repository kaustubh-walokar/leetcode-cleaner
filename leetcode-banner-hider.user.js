// ==UserScript==
// @name         LeetCode Banner Hider
// @namespace    http://tampermonkey.net/
// @version      0.5
// @description Add a toggle button to manually hide/show the banner at the top of LeetCode pages
// @author       You
// @match        https://leetcode.com/*
// @grant        none
// @homepage     https://github.com/kaustubh-walokar/leetcode-cleaner
// @downloadURL  https://raw.githubusercontent.com/kaustubh-walokar/leetcode-cleaner/mainline/leetcode-banner-hider.user.js
// @updateURL    https://raw.githubusercontent.com/kaustubh-walokar/leetcode-cleaner/mainline/leetcode-banner-hider.user.js
// ==/UserScript==
            ...
            for (let i = 0; i < elements.length; i++) {
                ...
                if (rect.top <= 50 && 
                    (element.tagName === 'HEADER' || 
                     ...
                     element.id === 'app' || // Common wrapper for LeetCode pages
                     element.classList.contains('app') ||
                     (element.textContent && 
                      (element.textContent.includes('LeetCode') || 
